...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "../assets/sds/bonded_pro_finish", 31);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "../assets/data/bonded_pro_finish", 31);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "../assets/sds/bonded_pro_pak_asphalt_patch", 32);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "../assets/data/bonded_pro_pak_asphalt_patch", 32);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds (part A)", "../assets/sds/bonded_pro_surface_partA", 33);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds (part B)", "../assets/sds/bonded_pro_surface_partB", 33);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "../assets/data/bonded_pro_surface", 33);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "../assets/data/bonded_pro_surface_90s", 34);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/productlines/quikrete5000concretemix.asp", 35);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/productlines/anchoringcement.asp", 36);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/productlines/concretebondingadhesive.asp", 37);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/productlines/corefillmasonrygrout.asp", 38);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/productlines/countertopmix.asp", 39);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/productlines/fastsettingconcretemix.asp", 40);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/productlines/hydraulicwaterstopcement.asp", 41);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/productlines/nonshrinkprecisiongrout.asp", 42);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/productlines/quicksettingcement.asp", 43);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/productlines/stuccoscratchandbrownbasecoat.asp", 44);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/US-EN/Tile-&-Stone-Installation-Systems/Bond-Promoting-Primer/ECO-Prim-Grip", 45);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/US-EN/Tile-&-Stone-Installation-Systems/Dry-Set-Mortars/Keraset", 46);

INSERT INTO PRODUCT (name, description, category, vendor) VALUES("Mapei Novoplan 2 Plus", "Professional Self-Leveling Underlayment<br><br>Novoplan 2 Plus is a high-strength, self-leveling cement-based underlayment and repair mix with quicker curing time, for interior concrete and engineer-approved floors.", "Tile Setting", "Mapei");

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/US-EN/Tile-&-Stone-Installation-Systems/Self-Leveling-Underlayments/Novoplan-2-Plus", 47);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/US-EN/Concrete-Restoration-Systems/Admixtures/Planicrete-AC", 48);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/US-EN/product-detail.asp?IDTipo=11488&IDLinea=103&IDMacroLinea=0&IDProdotto=2028302058", 49);

INSERT INTO PRODUCT (name, description, category, vendor) VALUES("Mapei Planiseal VS", "Alkali-Resistant, Epoxy Moisture-Reduction Barrier<br><br> Planiseal VS is an alkali-resistant, two-component, 100%-solids epoxy coating that effectively stops moisture-related problems with floor coverings. In addition, Planiseal VS expedites floor-covering installations by eliminating the traditional wait time required for new concrete slabs to reach moisture levels suitable for installations.", "Tile Setting", "Mapei");

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/US-EN/Floor-Covering-Installation-Systems/Moisture-Control-Products/Planiseal-VS", 50);

INSERT INTO PRODUCT (name, description, category, vendor) VALUES("Mapei Primer L", "Advanced-Technology, Acrylic Latex Primer for Concrete<br><br>Primer L is a concentrated, solvent-free acrylic primer used before the installation of underlayment materials. It is green for easy identification. Primer L improves the bond between a properly prepared and profiled concrete substrate, and self-leveling underlayment. Primer L can also be used as a primer for gypsum-based underlayments and patches.", "Tile Setting", "Mapei");

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/US-EN/Concrete-Restoration-Systems/Primers-for-Self-Leveling/Primer-L", 51);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/US-EN/Concrete-Restoration-Systems/Primers-for-Self-Leveling/Primer-T", 52);

INSERT INTO PRODUCT (name, description, category, vendor) VALUES("Mapei Ultraflex 1", "Standard Tile Mortar with Polymer<br><br>Ultraflex 1 is a standard-grade, single-component, polymer-modified thin-set mortar for most interior and exterior installations of tile. This mortar has an above average content of unique dry polymer, resulting in good adhesion to the substrate and tile. Ultraflex 1 can be used for both interior and exterior installations of tile in most residential floor and wall applications. In commercial applications, use on interior floor and wall installations and exterior floors.  Ultraflex 1 meets or exceeds ANSI A118.4 and ANSI A118.11 requirements when mixed with water.", "Tile Setting", "Mapei");

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/US-EN/Tile-&-Stone-Installation-Systems/Polymer-Modified-Mortars/Ultraflex-1", 53);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/productlines/corefillmasonrygrout.asp", 54);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.master-builders-solutions.basf.us/en-us/products/masterseal/masterseal-581", 55);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/US-EN/Concrete-Restoration-Systems/Waterproofing/Mapelastic-Smart", 56);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/2028300814-novoplan-2-plus-en.pdf", 57);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/NOVOPLAN_2_PLUS_SDS_EN.PDF", 57);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/2916-eco-prim-grip-en.pdf", 59);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/ECO_PRIM_GRIP_SDS_EN.pdf", 59);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/1005818-planiseal-vs-en.pdf", 60);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/PLANISEAL_VS_PART_A&B_SDS_EN.pdf", 60);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/1005778-primer-t-en.pdf", 61);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/PRIMER%20T_SDS_EN.pdf", 61);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/100363-planibond3c-en.pdf", 62);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/Planibond_3C_PartAB&C_EN.pdf", 62);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/unitex-propoxy-100.pdf?sfvrsn=49a5d560_19", 63);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-140048_-_pro-poxy_100_-_parts_ab_(us).pdf?sfvrsn=54a5d560_18", 63);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/unitex-propoxy-200.pdf?sfvrsn=f1a5d560_19", 64);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-140099_-_pro-poxy_200_-_parts_ab_(us).pdf?sfvrsn=fca5d560_22", 64);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/pro-poxy_204.pdf?sfvrsn=9a4d560_17", 65);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-100038_-_pro-poxy_204_-_parts_ab_(us).pdf?sfvrsn=14a4d560_20", 65);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/pro-poxy_300.pdf?sfvrsn=a1a6d560_27", 66);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-140144a_-_pro-poxy_300_-_parts_ab_(us).pdf?sfvrsn=aca6d560_27", 66);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/unitex-slow-set-bonding-agent.pdf?sfvrsn=21a4d560_15", 67);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-140430_-_slow_set_bonding_agent_-_parts_a-b_(usa).pdf?sfvrsn=2ca4d560_18", 67);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/pro-poxy_300_fast.pdf?sfvrsn=b9a6d560_39", 68);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-140177_-_pro-poxy_300_fast_-_parts_ab_(us).pdf?sfvrsn=c4a6d560_25", 68);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://glaze-n-seal.com/wp-content/uploads/2018/03/32_Efflorescence_Remover_GHS_SDS_03_08_2017.pdf", 69);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://glaze-n-seal.com/wp-content/uploads/2015/11/efflorescence-remover_12-12.pdf", 69);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.master-builders-solutions.basf.co.uk/en-gb/products/masterseal/masterseal-600-additive-for-cement-mixes", 70);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://gcpat.com/en/solutions/products/adva-high-range-water-reducers/adva-140m", 71);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://gcpat.com/en/solutions/products/adva-high-range-water-reducers/adva-140m", 71);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.aquafin.net/cmspdf/--23848-en.pdf", 72);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.aquafin.net/en/AQUAFIN-IC_ADMIX-590-655-product.html", 72);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://gcpat.com/en/solutions/products/daratard-hc", 73);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://gcpat.com/sites/gcpat.com/files/2017-06/SD60061_-_DCI-S_%28USGHS%29.pdf", 74);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.easyspred.com/Easy-Spred%20for%20Masonry%20Cut-Sheet%20(1).pdf", 75);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.dystar.com/industrial-foam-control-mineral-oil-based/foam-blast-325/", 76);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://gcpat-tools.com/construction/en-vn/Documents/Grace%20MicroFiber.pdf", 77);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/COM/products/Corrosion%20Inhibitors%20-MCI-2005-NS%20%2012.1.pdf", 78);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://cortecvci.com/Publications/PDS/MCI-2005%20NS.pdf", 79);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/PlanicreteAC_TDS_EA.pdf", 80);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/PLANICRETE_AC_SDS_EN.PDF", 80);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/1005812-planicrete-us-en.pdf", 81);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/PLANICRETE_UA_SDS_EN.pdf", 81);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://gcpat.com/sites/gcpat.com/files/2017-07/GCP0083_PS-1-1216_POLARSET_DS_Hi-res.pdf", 82);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://gcpat.com/sites/gcpat.com/files/2017-06/SD60147_-_POLARSET_%28USGHS%29.pdf", 82);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "../assets/sds/bonded_pro_crylic", 83);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "../assets/data/bonded_pro_crylic", 83);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://gcpat.com/sites/gcpat.com/files/2017-07/GCP0083_RECOVER-5-1216_RECOVER_HiRes.pdf", 84);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://gcpat.com/sites/gcpat.com/files/2017-06/SD60169_-_RECOVER_%28USGHS%29.pdf", 84);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://sinakcorp.com/products/repair-and-waterproofing/relay-resurfacer/", 85);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://gcpat.com/sites/gcpat.com/files/2017-08/STRUX%2090-40%20Datasheet.pdf", 86);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://gcpat.com/sites/gcpat.com/files/2018-05/SD60175_-_STRUX%2090%2040_%28USGHS%29.pdf", 86);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://gcpat.com/sites/gcpat.com/files/2017-06/SD60183_-_V-MAR%203_%28USGHS%29.pdf", 87);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://gcpat.com/sites/gcpat.com/files/2017-06/SD60192_-_WRDA-64%C2%AE_%28USGHS%29.pdf", 88);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.scofield.com/tdbpdf/2015/Cureseal-S-1631-32-05.pdf", 90);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.scofield.com/tdbpdf/SDS/SDS-Cureseal-S-Sealer-080315.pdf", 90);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://sinakcorp.com/wordpress/wp-content/uploads/2017/12/Lithium_Cure_1000_PIS_171204.pdf", 92);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://sinakcorp.com/wordpress/wp-content/uploads/2018/06/LC1000-SDS.pdf", 92);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/2028300917-mapecure-dr-en.pdf", 93);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/MAPECURE_DR_SDS_EN.PDF", 93);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/13-0084_Mapecrete_Hard_SI_EN_lr.pdf", 94);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/MAPECRETE_HARD_SI_SDS_EN.pdf", 94);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://sinakcorp.com/wordpress/wp-content/uploads/2015/11/S-102_PIS_151101.pdf", 95);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://sinakcorp.com/wordpress/wp-content/uploads/2015/11/S-102-SDS.pdf", 95);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/unitex-solvent-seal-1315.pdf?sfvrsn=d4a4d560_17", 96);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/83-140785_-_solvent_seal_1315_(us).pdf?sfvrsn=dfa4d560_16", 96);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/unitex-top-etch.pdf?sfvrsn=eca4d560_9", 97);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-140885_-_top_etch-regular_(usa).pdf?sfvrsn=2a3d560_10", 97);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.reefindustries.com/../assets/pdf/tg4000.pdf", 98);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "../assets/sds/bonded_unicure", 99);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "../assets/data/bonded_unicure", 99);
/*************************************/
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.master-builders-solutions.basf.us/en-us/products/sealants-caulks/masterseal-np-1", 100);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.master-builders-solutions.basf.us/en-us/products/sealants-caulks/masterseal-sl-1", 101);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.master-builders-solutions.basf.us/en-us/products/sealants-caulks/masterseal-p-173-and-p-176", 102);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://consumer.dow.com/en-us/document-viewer.html?ramdomVar=394600364019162069&docPath=/content/dam/dcc/documents/en-us/productdatasheet/61/61-885-dowsil-795-silicone-building-sealant.pdf", 103);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://consumer.dow.com/content/dam/dcc/documents/en-us/productdatasheet/62/62-017-dowsil-890-sl-si-joint-sealant.pdf", 104);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://consumer.dow.com/content/dam/dcc/documents/en-us/productdatasheet/62/62-586-dowsil-1199-silicone-glazing.pdf", 105);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://consumer.dow.com/en-us/document-viewer.html?ramdomVar=2741346752676951402&docPath=/content/dam/dcc/documents/en-us/productdatasheet/11/11-15/11-1546-dowsil-1200-os-primer.pdf", 106);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://consumer.dow.com/en-us/document-viewer.html?ramdomVar=2991727969430123452&docPath=/content/dam/dcc/documents/en-us/productdatasheet/63/63-1248-dowsil-primer-c-os.pdf", 107);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://consumer.dow.com/en-us/document-viewer.html?ramdomVar=3202151594314593143&docPath=/content/dam/dcc/documents/en-us/productdatasheet/62/62-1206-dowsil-construction-primer-p.pdf", 108);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.backerrod.com/media/98799/denverfoamtechdata-032014.pdf", 109);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.backerrod.com/media/336888/TitanFoamTechData_Aug2018.pdf", 110);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/unitex-propoxy-100.pdf?sfvrsn=49a5d560_19", 112);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-140048_-_pro-poxy_100_-_parts_ab_(us).pdf?sfvrsn=54a5d560_18", 112);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/unitex-propoxy-200.pdf?sfvrsn=f1a5d560_19", 113);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-140099_-_pro-poxy_200_-_parts_ab_(us).pdf?sfvrsn=fca5d560_22", 113);

INSERT INTO PRODUCT (name, description, category, vendor) VALUES("PRO-POXY 204", "Pro-Poxy 204 is a 100% solids, fast setting, two component, high modulus, medium viscosity, moisture tolerant structural epoxy adhesive that meets the requirements of ASTM C-881 and AASHTO M-235. The Pro-Poxy 204 is slightly thinner than the Pro-Poxy 200.", "Epoxy", "Dayton Superior");

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/pro-poxy_204.pdf?sfvrsn=9a4d560_17", 114);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-100038_-_pro-poxy_204_-_parts_ab_(us).pdf?sfvrsn=14a4d560_20", 114);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/pro-poxy_300.pdf?sfvrsn=a1a6d560_27", 115);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-140144a_-_pro-poxy_300_-_parts_ab_(us).pdf?sfvrsn=aca6d560_27", 115);

INSERT INTO PRODUCT (name, description, category, vendor) VALUES("SLOW SET BONDING AGENT", "Slow Set Bonding Agent is a 100% solids, two component, high modulus, medium viscosity, moisture tolerant, long open time structural epoxy adhesive meeting the requirements of ASTM C-881 and AASHTO M-235.", "Epoxy", "Dayton Superior");

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/unitex-slow-set-bonding-agent.pdf?sfvrsn=21a4d560_15", 116);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-140430_-_slow_set_bonding_agent_-_parts_a-b_(usa).pdf?sfvrsn=2ca4d560_18", 116);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/pro-poxy_300_fast.pdf?sfvrsn=b9a6d560_39", 117);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/87-140177_-_pro-poxy_300_fast_-_parts_ab_(us).pdf?sfvrsn=c4a6d560_25", 117);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.tnemec.com/resources/product/PDS/280.pdf", 118);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.tnemec.com/resources/product/MSDS/Series%20280%20SDS_Eng.pdf", 118);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.tnemec.com/resources/product/PDS/435.pdf", 119);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.tnemec.com/resources/product/MSDS/Series%20435%20SDS_Eng.pdf", 119);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.tnemec.com/resources/product/PDS/237.pdf", 120);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.tnemec.com/resources/product/MSDS/237%20SDS_Eng.pdf", 120);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://glaze-n-seal.com/wp-content/uploads/2018/03/42_Acrylic_Floor_Polish_GHS_SDS_01_09_2018.pdf", 122);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.scofield.com/tdbpdf/2015/Cureseal-W-1623-09.pdf", 123);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.tnemec.com/resources/product/PDS/664.pdf", 124);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.tnemec.com/resources/product/MSDS/664%20SDS_Eng.pdf", 124);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.master-builders-solutions.basf.us/en-us/products/water-repellent/surface-applied/masterprotect-h-400", 125);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://worldaccount.basf.com/wa/NAFTA~en_US/Catalog/ConstCommercial/info/BASF/PRD/30605624", 126);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://glaze-n-seal.com/wp-content/uploads/2015/03/gripNseal.pdf", 127);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://glaze-n-seal.com/wp-content/uploads/2016/02/43_Grip_N_Seal_GHS_SDS_01_25_2016.pdf", 127);

INSERT INTO PRODUCT (name, description, category, vendor) VALUES("KURE 1315", "Kure 1315 is a transparent waterbased blend of acrylic polymers used to cure, seal and dustproof freshly placed and finished concrete floors. it contains no oils, saponifiable resins, waxes or chlorinated rubbers. It complies with ASTM C 1315, Type I, Class A.", "Sealers", "BASF");

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.master-builders-solutions.basf.us/en-us/products/concrete-surface-treatment/concrete-curing-compounds/masterkure-cc-1315wb", 128);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://desertbrand.com/wpDesert/wp-content/uploads/2017/06/MasterSealTechBullV2.pdf", 129);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://hillbrothers.com/pdf/downloads/msds/sds/db-ms-100-cp-sds.pdf", 129);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("color chart", "https://desertbrand.com/color-charts/classic-sealer-color-chart/", 129);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://glaze-n-seal.com/wp-content/uploads/2015/11/multipurposesealer-1-2.pdf", 130);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://glaze-n-seal.com/wp-content/uploads/2018/03/13_Multi-Purpose_Sealer_GHS_SDS_01_09_2018.pdf", 130);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://glaze-n-seal.com/wp-content/uploads/2015/11/penetratingsealer-1-1.pdf", 131);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://glaze-n-seal.com/wp-content/uploads/2016/02/14_Natural_Look_Penetrating_Sealer_GHS_SDS_02_01_2016.pdf", 131);

INSERT INTO PRODUCT (name, description, category, vendor) VALUES("S-102", "Sinak Sealer S-102 was formulated to waterproof, preserve and protect concrete by working with the chemistry of concrete. It penetrates the concrete, and combines with the soluble calcium compounds to form additional insoluble silicate structure within the concrete. The newly-formed breathing protective barrier retains all of the properties of healthy concrete except one: The extreme moisture attraction of the calcium hydroxide normal to the capillary channels in the concrete is neutralized because of its conversation to an insoluble compound.", "Sealers", "Sinak");

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.bondedmaterials.net/../assets/data/sinak_s102.pdf", 132);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://sinakcorp.com/wordpress/wp-content/uploads/2015/11/S-102-SDS.pdf", 132);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.scofield.com/tdbpdf/2015/Selectseal-Plus-1645-04.pdf", 133);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://sinakcorp.com/wordpress/wp-content/uploads/2017/12/Lithium_Cure_2000_PIS_171204.pdf", 134);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://sinakcorp.com/wordpress/wp-content/uploads/2016/09/LC2000-SDS.pdf", 134);

INSERT INTO PRODUCT (name, description, category, vendor) VALUES("SOLVENT SEAL 1315", "Solvent Seal 1315 is an acrylic copolymer cure, seal and dustproofing compound in an aromatic solvent containing 25% solids with special UV stabilizers. The higher acrylic solids content will form an excellent surface coating with a high gloss finish and will provide an outstanding cure performance. Solvent Seal 1315 is ultraviolet light stable and resists yellowing.", "Sealers", "Dayton Superior");

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.daytonsuperior.com/docs/default-source/tech-data-sheets/unitex-solvent-seal-1315.pdf?sfvrsn=d4a4d560_17", 135);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.daytonsuperior.com/docs/default-source/msds-documents/83-140785_-_solvent_seal_1315_(us).pdf?sfvrsn=dfa4d560_16", 135);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://glaze-n-seal.com/wp-content/uploads/2015/11/stain-defense-3-11.pdf", 136);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://glaze-n-seal.com/wp-content/uploads/2016/02/95_Stain_Defense_GHS_SDS_01_25_2016.pdf", 136);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://glaze-n-seal.com/wp-content/uploads/2015/11/stone-color-enhancer_12-121.pdf", 137);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://glaze-n-seal.com/wp-content/uploads/2016/02/96_Stone_Color_Enhancer_GHS_SDS_01_25_2016.pdf", 137);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://glaze-n-seal.com/wp-content/uploads/2015/11/stonesealant_data-3.pdf", 138);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://glaze-n-seal.com/wp-content/uploads/2016/02/75_Stone_Sealant_Impregnator_GHS_SDS_01_25_2016.pdf", 138);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://glaze-n-seal.com/wp-content/uploads/2015/11/wet_look_con_msnry_lacq12-12.pdf", 139);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://glaze-n-seal.com/wp-content/uploads/2018/03/12_Wet_Look_Lacquer_GHS_SDS_01_09_2018.pdf", 139);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/13-0084_Mapecrete_Hard_SI_EN_lr.pdf", 140);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/MAPECRETE_HARD_SI_SDS_EN.pdf", 140);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.scofield.com/tdbpdf/2015/FormulaOneLithiumDensifier-1830-05.pdf", 141);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.scofield.com/tdbpdf/2015/FormulaOneGuard-W-1880-03.pdf", 142);

INSERT INTO PRODUCT (name, description, category, vendor) VALUES("MAPECRETE HARD SI", "Mapecrete Hard SI is a clear, water-based sodium silicate densifier used to harden and dustproof concrete surfaces. It chemically reacts with the free lime and calcium carbonate in concrete, forming a dense, insoluble and chemically resistant surface. Mapecrete Hard SI is a VOC-free, colorless and odorless chemical solution that may be applied to horizontal interior, fresh or hardened concrete. Floors treated with Mapecrete Hard SI resist the penetration of water, oil and chemicals.", "Concrete Densifiers", "Mapei");

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/13-0084_Mapecrete_Hard_SI_EN_lr.pdf", 143);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/MAPECRETE_HARD_SI_SDS_EN.pdf", 143);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.quikrete.com/pdfs/data_sheet-mason%20mix%201136.pdf", 144);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://www.quikrete.com/pdfs/sds-c4-masonry-mortars.pdf", 144);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/Keraset_TDS_EA.pdf", 145);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds (white)", "http://www.mapei.com/public/US/products/KERASET_SDS_WHITE_EN.PDF", 145);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds (grey)", "http://www.mapei.com/public/US/products/KERASET_SDS_GRAY_EN.PDF", 145);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/2103-mapelastic-aquadefense-en.pdf", 146);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/MAPELASTIC_AQUA_DEFENSE_SDS_EN.PDF", 146);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.scofield.com/tdbpdf/2015/AntiquingRelease-1410-11.pdf", 147);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.scofield.com/MSDS/AntRelease_10_12.pdf", 147);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.scofield.com/tdbpdf/2015/LiquidRelease-3611-06.pdf", 148);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.scofield.com/tdbpdf/SDS/SCOFIELDLiquidRelease-BG-SDS.pdf", 148);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://daytonsuperior.com/docs/default-source/tech-data-sheets/unitex-farm-fresh-xl.pdf?sfvrsn=87a3d560_11", 149);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://daytonsuperior.com/docs/default-source/msds-documents/83-143495_-_farm_fresh_xl_(usa).pdf?sfvrsn=92a3d560_12", 149);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://hasapool.com/wp-content/uploads/Muriatic-Acid-SDS.pdf", 151);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://glaze-n-seal.com/wp-content/uploads/2015/03/Stripper.pdf", 152);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://glaze-n-seal.com/wp-content/uploads/2018/03/21_Paint_and_Coating_Stripper_GHS_SDS_01_9_2018.pdf", 152);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://glaze-n-seal.com/wp-content/uploads/2016/04/Oil-stain-remover.pdf", 153);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "../assets/data/bonded_basalt_sand.pdf", 154);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "../assets/data/bonded_basalt_rock.pdf", 155);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "../assets/data/bonded_coral_sand.pdf", 156);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "../assets/data/bonded_coral_rock.pdf", 157);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://consumer.dow.com/content/dam/dcc/documents/en-us/productdatasheet/62/62-048-dowsil-allguard-silicone-elastomer-coating.pdf", 164);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://consumer.dow.com/en-us/pdp.dowsil%E2%84%A2%20allguard%20silicone%20elastomeric%20coating%20deep%20tint%20base.04114040z.html?tab=sds&id=04114040z", 164);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://consumer.dow.com/content/dam/dcc/documents/en-us/productdatasheet/62/62-1182-dowsil-allguard-primer.pdf", 165);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://consumer.dow.com/en-us/pdp.dowsil%E2%84%A2%20allguard%20primer.03141021h.html?tab=sds&id=03141021h", 165);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.aquafin.net/cmspdf/--23848-en.pdf", 166);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.aquafin.net/en/AQUAFIN-IC_ADMIX-590-655-product.html", 166);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/2103-mapelastic-aquadefense-en.pdf", 167);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/MAPELASTIC_AQUA_DEFENSE_SDS_EN.PDF", 167);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://cdnmedia.mapei.com/docs/librariesprovider14/products-documents/2013-mapelasticsmart-aus21deb77479c562e49128ff01007028e9.pdf?sfvrsn=e97e5d71_0", 168);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds (a & b)", "https://www.mapei.com/au/en/products-and-solutions/products/detail/mapelastic-smart", 168);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "../assets/data/mapei_fiberglass_mesh.pdf", 169);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/1005818-planiseal-vs-en.pdf", 170);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/PLANISEAL_VS_PART_A&B_SDS_EN.pdf", 170);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.mapei.com/public/US/products/1005778-primer-t-en.pdf", 171);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.mapei.com/public/US/products/PRIMER%20T_SDS_EN.pdf", 171);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.master-builders-solutions.basf.us/en-us/products/deck-coatings/masterseal-traffic-1500", 173);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.master-builders-solutions.basf.co.uk/en-gb/products/masterseal/masterseal-600-additive-for-cement-mixes", 174);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.master-builders-solutions.basf.us/en-us/products/waterproofing/split-slab-and-below-grade-waterproofing/masterseal-hlm-5000", 175);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.master-builders-solutions.basf.us/en-us/products/waterproofing/cementitious-coatings/masterseal-581", 176);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://www.master-builders-solutions.basf.us/en-us/products/waterproofing/cementitious-coatings/masterseal-581", 176);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.scofield.com/tdbpdf/2015/Chemstain-1320-19.pdf", 177);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("color chart", "http://www.scofield.com/tdbpdf/brochures/LITHOCHROME-Chemstain-A412.pdf", 177);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds (black)", "http://www.scofield.com/tdbpdf/SDS/SDS-Chemstain-1_2-011118.pdf", 177);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.daviscolors.com/tech-and-safety-data-sheets/", 178);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://www.daviscolors.com/tech-and-safety-data-sheets/", 178);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.liquiblack.com/", 179);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.liquiblack.com/", 180);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.scofield.com/tdbpdf/2015/Tintura-7340-09.pdf", 181);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("color chart", "http://www.scofield.com/tdbpdf/brochures/LITHOCHROME-Tintura-A422.pdf", 181);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "http://www.scofield.com/tdbpdf/SDS/LITHOCHROME-Tintura-PartA-SDS.pdf", 181);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "http://www.scofield.com/tdbpdf/2015/Selectseal-Plus-1645-04.pdf", 182);
...
INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://www.euclidchemical.com/fileshare/ProductFiles/TDS/Decorative/Stone_Essence.pdf", 183);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://www.euclidchemical.com/fileshare/ProductFiles/MSDS/CSES_O032_830_U.pdf", 183);

INSERT INTO PRODUCT (name, description, category, vendor) VALUES("ALLGUARD (SPECIAL ORDER ONLY)", "Dow Corning AllGuard Silicone Elastomeric Coating is designed to waterproof above-grade exterior masonry substrates, such as concrete block, fluted block, brick, stucco, synthetic stucco, poured concrete, precast concrete, exterior insulation finish systems (EIFS), and previously coated masonry substrates.", "Coloring & Stain", "Dow Corning");

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("data", "https://consumer.dow.com/content/dam/dcc/documents/en-us/productdatasheet/62/62-048-dowsil-allguard-silicone-elastomer-coating.pdf", 184);

INSERT INTO PRODUCT_IMAGE (name, image_path, product_id) VALUES("sds", "https://consumer.dow.com/en-us/pdp.dowsil%E2%84%A2%20allguard%20silicone%20elastomeric%20coating%20deep%20tint%20base.04114040z.html?tab=sds&id=04114040z", 184);
